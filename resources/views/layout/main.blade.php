    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><h4>Toko Online</h4></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        ...
                        <a href="/produsen"> <i class="menu-icon fa fa-laptop"></i>Produsen</a>
                        <a href="/jenisbarang"> <i class="menu-icon fa fa-th"></i>Jenis Barang</a>
                        <a href="/barang"> <i class="menu-icon fa fa-puzzle-piece"></i>Barang</a>
